module.exports = ({workexpduration1,furtherduration,workexpduration2,schoolduration,collegeduration, name, profession,age, contact,email,objectives,eduschool,educollege,edufurther,workexp1,workexp2 }) => {
  ...
  <div class="wrapper-mid">
    ...
    <div id="paper">
      ...
      <div id="paper-mid">
        <div class="entry">
          <!-- Begin Image -->
          <img class="portrait" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQSYtKMZne2YXSUggshooAnLNQIASLfpcCRSW9R7eZUpFfPu8ih" alt="John Smith" />
          <!-- End Image -->
          <!-- Begin Personal Information -->
          <div class="self">
            <h1 class="name">${name} <br /><br /><br /><br />
              <span>${profession}</span></h1>
            <ul>
              <li class="ad">${age}</li>
              <li class="mail">${email}</li>
              <li class="tel">${contact}</li>
            </ul>
          </div>
        ...
        <div class="entry">
          <h2>EDUCATION</h2>
          <div class="content">
            <h3>${schoolduration}</h3>
            <p>${eduschool}
             </p>
          </div>
          <div class="content">
            <h3>${collegeduration}</h3>
            <p>${educollege}
             </p>
          </div>
          <div class="content">
            <h3>${furtherduration}</h3>
            <p>${edufurther}
             </p>
          </div>
        </div>
        ...
        <div class="entry">
          <h2>EXPERIENCE</h2>
          <div class="content">
            <h3>${workexpduration1}</h3>
            <p>${workexp1}<br />
          </div>
          <div class="content">
            <h3>${workexpduration2}</h3>
            <p>${workexp2}<br />
          </div>
        <!-- End 3rd Row -->
        <!-- Begin 4th Row -->
